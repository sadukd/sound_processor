...
int16_t Waveform::getSample(size_t i) const { return _samples.at(i); }

void Waveform::setSample(size_t i, int16_t sample) { _samples.at(i) = sample; }
...
const std::vector<int16_t>& Waveform::getSamples() const
{
    return _samples;
}